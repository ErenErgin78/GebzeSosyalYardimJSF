...
ABC_ID --> Primary key olacak olan ilk sütunumuzdur, tabloyu oluştururken şu şekilde oluşturarak otomatik olarak artmasını sağlayabilirsiniz: ABC_ID NUMBER GENERATED by default on null as IDENTITY
